...
var PermsMap = map[string]SNativeFuncDescription{
	"054556ac": {"has_role", 2, ptypes.HasRole, has_role},
	"180d26f2": {"unset_base", 2, ptypes.UnsetBase, unset_base},
	"3a3fcc59": {"set_global", 2, ptypes.SetGlobal, set_global},
	"9a1c4141": {"add_role", 2, ptypes.AddRole, add_role},
	"9ea53314": {"set_base", 3, ptypes.SetBase, set_base},
	"bb37737a": {"has_base", 2, ptypes.HasBase, has_base},
	"ded3350a": {"rm_role", 2, ptypes.RmRole, rm_role},
}
